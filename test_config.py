...
class TestProviders(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''initialize providers resources tests'''
        ...
        '''initialize customers resources tests'''
        ...
        '''initialize events resources tests'''
    ...
    '''TESTING PROVIDERS RESOURCES'''
    '''Tests post a specific provider'''
    ...
    '''Tests get for a specific provider'''
    ...
    '''Test delete for a specific provider'''
    def test_200_delete_provider(self):
        res = self.client().delete('/providers/{}'.format(self.provider_id),
    ...
    '''TESTING CUSTOMERS RESOURCES'''
    '''Tests post a customer'''
    ...
    '''Tests get all customers routes'''
    ...
    '''Tests get for a specific customer'''
    ...
    def test_200_delete_customer(self):
        res = self.client().delete('/customers/{}'.format(self.customer_id),
                                        headers={'Content-Type': 'application/json',
                                                 'Authorization': 'Bearer {}'.format(self.customer_token)})
        data = json.loads(res.data)
        print(data)
    ...
    def test_400_edit_events(self):
        res = self.client().patch('/events/1', headers={'Content-Type': 'application/json',
                                                        'Authorization': 'Bearer {}'.format(self.events_token)},
                                               json={'MISSPEL_name': 'EDITED NAME',
                                                     'rating': 'WRONG DATA'})
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 400)
        self.assertEqual(data['success'], False)

    '''Tests delete a event'''
    def test_200_delete_events(self):
        res = self.client().delete('/events/{}'.format(self.event_id),
                                    headers={'Content-Type': 'application/json',
                                               'Authorization': 'Bearer {}'.format(self.events_token)})
        data = json.loads(res.data)
        print(data)
